...
shortest_handle = $handle_array[0]
...
$handle_array.each do |handle|
  length_array << handle.length
end

sorted_length_array = length_array.sort

puts sorted_length_array
print sorted_length_array

shortest_length = sorted_lengths.first
shortest_handle_index = lengths.index(shortest_length)
shortest_handle = $handle_array[shortest_handle_index]

puts "Shortest handle: #{shortest_handle}"

-----------


new_array = $handle_array.sort
print new_array

-----------

shortest_name = $handle_array.min_by { |handle| handle.length }

puts "The shortest name is: #{shortest_name}"
